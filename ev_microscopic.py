...
""")
    ...
    with col2:
        ...
        st.markdown("กดด้านกาวลงบน **ผิวหนังรอบๆ ทวารหนัก** โดยทำซ้ำๆ ให้ทั่วบริเวณ")

    with col3:
        st.markdown("### 3. ปิดผนึก")
        st.markdown("นำเทปแปะลงบน **กระจกสไลด์** ให้เรียบร้อย และนำไปส่องภายใต้กล้องจุลทรรศน์")
    st.divider()
